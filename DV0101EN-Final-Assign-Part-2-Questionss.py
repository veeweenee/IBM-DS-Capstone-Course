...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Year',
            y='Automobile_Sales',
            title="Average Automobile Sales by Vehicle Type over the Recession Period"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            values='Recession',
            names='Vehicle_Type',
            title='Total Advertising Expenditure Share by Vehicle Type during the Recessions')
        )
